      ...
      <div className="flex justify-between items-start bg-white rounded-lg">
        <div className="text-center p-8 shadow-lg">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold py-6 text-slate-700">
              Current Plan Details
            </h3>
            <div className="space-x-24 px-4">
              <span className="text-[#1f4d90] bg-[#EAF4FE] px-2 py-1 rounded text-sm font-semibold">
                Active
              </span>
              <span className="text-[#1f4d90] text-sm font-semibold">
                <a
                  href="./cancel"
                  className="text-[#1f4d90] text-sm font-semibold"
                >
                  Cancel
                </a>
              </span>
          ...
          <div className="text-[green] px-2 py-1 pb-4 rounded text-md font-semibold">
